...
template <Comparable Type>
typename Tree<Type>::TreeNode &Tree<Type>::TreeNode::operator=(const TreeNode &other) = default;

template <Comparable Type>
typename Tree<Type>::TreeNode &Tree<Type>::TreeNode::operator=(TreeNode &&other) noexcept = default;
