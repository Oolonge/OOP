...
int main()
{
    try
    {
        ...
        cout<< "  Vector of a given length "<< lenExample<< endl;
        ...
        cout<< "  Non orthogonality: "<<orthVecF.isOrthgonal(nonOrthVec)<< endl;
        ...
        colVecF = {5, 2, 0};
        cout<< "  Non collinearity: "<< colVecF.isCollinear(colVecS)<< endl;
